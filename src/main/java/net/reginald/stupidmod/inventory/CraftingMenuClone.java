...
public class CraftingMenuClone extends RecipeBookMenu<CraftingContainer> {
    ...
    public CraftingMenuClone(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public CraftingMenuClone(int pContainerId, Inventory pPlayerInventory, ContainerLevelAccess pAccess) {
    ...
    protected void slotChangedCraftingGrid(AbstractContainerMenu pMenu, Level pLevel, Player pPlayer, CraftingContainer pContainer, ResultContainer pResult) {
        if (!pLevel.isClientSide) {
            ...
            if (optional.isPresent()) {
                ...
                if (pResult.setRecipeUsed(pLevel, serverplayer, craftingrecipe)) {
                    ...
                    if (craftingAllowed(itemstack1, pLevel)) {
    ...
    protected boolean craftingAllowed(ItemStack itemstack, Level pLevel){
        return itemstack.isItemEnabled(pLevel.enabledFeatures());
    }
